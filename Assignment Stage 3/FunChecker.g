...
// EXTENSION: Enzo Roiz - ID:2161561 - Date: 09/11/2014
//
//////////////////////////////////////////////////////////////
...
for_var_decl		returns [Type type]							// EXTENSION FOR
	:	^(FORVAR INT ID t=expr)								// EXTENSION FOR
				{ define($ID.text, Type.INT, $FORVAR);				// EXTENSION FOR
...
com
	...
	|	^(FOR t1=for_var_decl t2=expr com)						// EXTENSION FOR
				{ checkType(Type.INT, t1, $FOR);				// EXTENSION FOR
				  checkType(Type.INT, t2, $FOR); 				// EXTENSION FOR
				}								// EXTENSION FOR
	|	^(REPEAT com t=expr)								// EXTENSION REPEAT UNTIL
				{ checkType(Type.BOOL, t, $REPEAT);				// EXTENSION REPEAT UNTIL
